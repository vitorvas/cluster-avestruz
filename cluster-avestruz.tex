...
configuração, garantir o backup do arquivo atual em caso de falhas renomeando-o:
...
Com o sistema configurado para modo multi-usuário (ou \textit{non-graphical}) 
...
como o CUDA oferecido pela própria Nvídia.
